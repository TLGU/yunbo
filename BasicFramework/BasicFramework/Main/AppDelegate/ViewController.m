...
//    UIImage *img = [UIImage imageNamed:@"default.jpg"];
//    
//    _imageView=[[UIImageView alloc] initWithImage:img];
//    
//    _imageView.contentMode=UIViewContentModeCenter;
//    
//    [_imageView setFrame:CGRectMake(0, 0, kScreenWidth  , kScreenHeight-64)];
//    
//    [self.view addSubview:_imageView];
//    
//    [self refreshImageView];
//    
//    UIBarButtonItem *rightItem=[[UIBarButtonItem alloc] initWithTitle:@"编辑" style:UIBarButtonItemStylePlain target:self action:@selector(pushedEditBtn)];
//    
