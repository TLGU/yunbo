...
- (void)doPushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    UICollectionViewCell *cell = (UICollectionViewCell *)[fromVC.collectionViewDown cellForItemAtIndexPath:fromVC.currentIndexPath];
...
- (void)doPopAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    UICollectionViewCell *cell = (UICollectionViewCell *)[toVC.collectionViewDown cellForItemAtIndexPath:toVC.currentIndexPath];
    UIView *containerView = [transitionContext containerView];
