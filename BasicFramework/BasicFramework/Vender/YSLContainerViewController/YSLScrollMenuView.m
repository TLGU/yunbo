...
//static const CGFloat kYSLScrollMenuViewWidth  =70;
#define kYSLScrollMenuViewWidth kScreenWidth/2.0f
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemfont = [UIFont systemFontOfSize:22];
...
//#warning update
//             NSString *title   =itemTitleArray[i];
//          CGRect rect=  [title boundingRectWithSize:CGSizeMake(MAXFLOAT, CGRectGetHeight(self.frame)) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:_itemfont} context:nil];
            
            CGRect frame = CGRectMake(0, 0, kYSLScrollMenuViewWidth, CGRectGetHeight(self.frame));
//            CGRect frame = CGRectMake(0, 0, rect.size.width, CGRectGetHeight(self.frame));
